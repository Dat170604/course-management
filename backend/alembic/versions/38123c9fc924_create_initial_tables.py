...
down_revision: str | Sequence[str] | None = "734e95f14e86"
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["course_id"], ["courses.id"], name=op.f("enrollments_ibfk_1")
        ),
        sa.ForeignKeyConstraint(
            ["student_id"], ["users.id"], name=op.f("enrollments_ibfk_2")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["teacher_id"], ["users.id"], name=op.f("courses_ibfk_1")
        ),
        sa.PrimaryKeyConstraint("id"),
        mysql_collate="utf8mb4_0900_ai_ci",
        mysql_default_charset="utf8mb4",
